   <div style="background-color:#c73380;" data-role="header">
                <a  style="background-color:#c73380;   color: white; text-shadow: none;"href="#myPopup2" data-rel="popup"  data-icon="home"> &nbsp;Sign out/Change Data/Topic </a>
                ...
                <div data-role="popup" id="myPopup2" data-position-to="origin" data-transition="flip" class="ui-content" style="min-width:250px;">
...
<div data-role="fieldcontain">
                    ...
                    <select class="target2" name="select-choice-1" >
                        <?php
  ...
  <div id = "div1"class="ui-grid-a">
                <div id="blocka" class="ui-block-a">
                    <div data-role="fieldcontain">
                        ...
                        <input id="date2" type="text" class="date-input-inline" data-inline="false" data-role="date" >
                    </div>
                </div>
                <br>
